...
<title>Let's Go | Atualizar Cliente</title>
</head>
<body>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-6">
				<h1 class="mt-5">Atualizar Cliente | Let's Go</h1>
				<form class="mt-5" action="UpdateController" method="post">
					...
					<div class="form-group">
						<label for="cpf">CPF:</label> <input type="text"
							...
							value="${cliente.cpfCliente}" required>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="senhaCliente">Senha:</label> <input type="text"
							class="form-control" id="senha" name="senha"
							value="${cliente.senhaCliente}" required>
					</div>

					<button type="submit" class="btn btn-primary mb-5">Atualizar</button>
					<a href="./ReadController" class="btn btn-outline-secondary mb-5">Voltar</a>
					<br> <br> <br> <br>
